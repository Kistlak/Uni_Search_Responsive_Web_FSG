...
<head>
        ...
        <title>Registration Page || Academia</title>
...
$sql = "INSERT INTO apply (course,fname,lname,adone,adtwo,city,country,num,email,gender,year,month,date) VALUES
('$_POST[course]','$_POST[fname]','$_POST[lname]','$_POST[adone]','$_POST[adtwo]','$_POST[city]','$_POST[country]','$_POST[num]','$_POST[email]','$_POST[gender]','$_POST[year]','$_POST[month]','$_POST[date]')";
